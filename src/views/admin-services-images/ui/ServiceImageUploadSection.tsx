...
import { useUploadServiceImageMutation } from '@/features/service-image-editor'
 ...
 */
export function ServiceImageUploadSection() {
  const fileInputRef = useRef<HTMLInputElement>(null)
  const [isDragOver, setIsDragOver] = useState(false)
  const uploadMutation = useUploadServiceImageMutation()
