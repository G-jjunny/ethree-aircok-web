export const DASHBOARD_CARDS = [
  ...
  {
    href: "/console/indoor-images",
    title: "실내 공기질 이미지 관리",
    description:
      "실내 공기질 관리 시스템 섹션의 고정 자리 이미지를 관리합니다.",
    icon: (
      <svg
        className="w-6 h-6"
        fill="none"
  ...
  {
    href: "/console/service-reviews",
    title: "서비스 신청 이유 관리",
    description:
      "진단서비스 페이지의 고객 신청 이유(후기)를 등록·수정·정렬합니다.",
    icon: (
      <svg
        className="w-6 h-6"
        fill="none"
  ...
  {
    href: "/console/diagnosis-section-images",
    title: "진단 구성·비교 이미지 관리",
    description:
      "진단서비스 페이지의 구성 이미지와 도입 전후 비교 이미지를 관리합니다.",
    icon: (
      <svg
        className="w-6 h-6"
        fill="none"
