  ...
  return (
    <div className="flex flex-col gap-8 max-w-3xl">
      ...
      <section className="flex flex-col gap-3">
        <h2 className="text-ink font-display font-semibold text-lg">
          문의 폼 필드
        </h2>
        {fields.length === 0 ? (
          <div className="flex flex-col items-center justify-center text-center gap-4 rounded-card border border-hairline bg-surface-white px-6 py-12">
            <p className="text-ink-soft font-body text-sm leading-[1.43] [word-break:keep-all]">
              등록된 필드가 없습니다. 아래에서 첫 필드를 추가하세요.
            </p>
          </div>
        ) : (
          <ul className="border border-hairline rounded-card divide-y divide-hairline">
